...
* @author Chinwe
* Thanks for the awesome lib, Chinwe! I definitely appreciate the fact that there's people out there who
* do such nice things for others that they don't even know. Thanks again!
*/
public class UtilScroll
{
    ...
    */
    public UtilScroll(String message, int width, int spaceBetween, char colourChar)
    {
